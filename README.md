...
Tokens are used for authenticating a client that's connected to or trying to connect to a web application. 

- [ ] What steps can you take in your web apps to keep your data secure?

Keeping packages updated, use authentication tokens and enforce a strong password policy.

- [ ] Describe how web servers work.

Web server could refer to one of two things - a server computer or server software. Clients connect to the web server typically through a domain name and then the server may respond with data such as a react bundle back to the client.
